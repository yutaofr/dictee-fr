...
### Key Technologies
- **Frontend:** Vanilla JavaScript, HTML5, CSS3 (Glassmorphism aesthetic).
...
The application logic in `app.js` (**runDictee**) MUST preserve this structure:
...
## 📂 Key File Map
- `app.js`: Main frontend controller and dictation state machine.
- `server.js`: Node.js proxy with MD5-based audio caching.
